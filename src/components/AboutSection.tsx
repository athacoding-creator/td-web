  ...
  return (
    <section id="tentang" className="py-12 bg-background">
      <div className="px-4">
        ...
        {/* Values - 3 Columns Horizontal */}
        <div className="grid grid-cols-3 gap-3 mt-8">
          <div className="flex flex-col items-center text-center p-4 rounded-xl bg-secondary/50 border border-border/50">
            <div className="w-12 h-12 mb-3 rounded-full cta-gradient flex items-center justify-center">
              <svg className="w-6 h-6 text-primary-foreground" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
              </svg>
            </div>
            <div>
              <h3 className="font-heading font-bold text-sm text-foreground mb-1">Dakwah</h3>
          ...
          <div className="flex flex-col items-center text-center p-4 rounded-xl bg-secondary/50 border border-border/50">
            ...
            <div>
              <h3 className="font-heading font-bold text-sm text-foreground mb-1">Pendidikan Islam</h3>
          ...
          <div className="flex flex-col items-center text-center p-4 rounded-xl bg-secondary/50 border border-border/50">
            ...
            <div>
              <h3 className="font-heading font-bold text-sm text-foreground mb-1">Sosial & Kemanusiaan</h3>
