        ...
        <div className="min-h-screen flex flex-col">
          ...
          <main className="flex-1 flex items-center justify-center bg-background px-4">
            <div className="text-center">
              <h1 className="text-xl font-heading font-bold mb-4">Artikel tidak ditemukan</h1>
              <Link to="/artikel" className="text-primary hover:underline text-sm">
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-1 bg-background">
          ...
          <div className="px-4 py-6">
            ...
            {/* Title */}
            <h1 className="text-xl font-heading font-bold text-foreground mb-4 leading-tight">
              {article.title}
            </h1>
            ...
            <Link
              to="/artikel"
              className="inline-flex items-center gap-2 mt-6 text-sm text-primary hover:text-primary/80 font-medium transition-colors"
            >
            ...
            {otherArticles.length > 0 && (
              <div className="mt-8 pt-6 border-t border-border">
                <h3 className="font-heading font-semibold text-base mb-4 text-foreground">
                  Artikel Lainnya
                </h3>
