                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      Menjadi pusat dakwah Islam yang rahmatan lil alamin, mencerahkan umat 
                      dengan ilmu dan akhlak mulia, serta menjadi rujukan dalam pembinaan 
                      karakter Islami yang bermanfaat bagi masyarakat.
                    </p>
                  </div>
