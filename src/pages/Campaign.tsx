              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {campaigns.map((campaign) => {
                  ...
                  return (
                    <div
                      key={campaign.id}
                      className="bg-card rounded-xl border-2 border-border overflow-hidden hover:shadow-2xl hover:border-primary/30 transition-all duration-300 flex flex-col"
                    >
                      {/* Image */}
                      {campaign.image_url && (
